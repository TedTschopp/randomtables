...
gen_data['book_condition'] = {
	'1-46': 'unreadable and in small pieces.  Little information can be gleaned from this work without a great deal of effort, and is only {d8*10} complete.',
	/* 3D6 =3 */
	'47-185': 'unreadable and in small pieces.  Little information can be gleaned from this work without a great deal of effort, and is only {d8*10} complete.',
	/* 3D6 =4 */
	'186-462': 'nearly unreadable, it is missing parts and in fragments, but the majority of the work is intact.  The ink is faded, and flaked off in places.  Margins are worn, torn and burned intrudes into the text.  The pages are stained.  The book will be 80% to 100% complete.',
	/* 3D6 =5 */
	'463-925': 'nearly unreadable, it is missing parts and in fragments, but the majority of the work is intact.  The ink is faded, and flaked off in places.  Margins are worn, torn and burned intrudes into the text.  The pages are stained.  The book will be 80% to 100% complete.',
	/* 3D6 =6 */
	'926-1620': 'intact but in bad condition. It is missing the cover page and has bad stains on some pages, while others are tattered.',
	/* 3D6 =7 */
	'1621-2592': 'intact but in bad condition. It is missing the cover page and has bad stains on some pages, while others are tattered.',
	/* 3D6 =8 */
	'2593-3750': 'worn with loose pages, a broken spine and dog ears pages but the book is whole and readable.',
	/* 3D6 =9 */
	'3751-5000': 'worn with loose pages, a broken spine and dog ears pages but the book is whole and readable.',
	/* 3D6 =10 */
	'5001-6250': 'showing sign of wear and heavy use, but is unbroken or stained.',
	/* 3D6 =11 */
	'6251-7407': 'showing sign of wear and heavy use, but is unbroken or stained.',
	/* 3D6 =12 */
	'7408-8379': 'showing some signs of shelf wear',
	/* 3D6 =13 */
	'8380-9074': 'showing some signs of shelf wear',
	/* 3D6 =14 */
	'9075-9537': 'is as new, but has small signs of wear.',
	/* 3D6 =15 */
	'9538-9814': 'is as new, but has small signs of signs.',
	/* 3D6 =16 */
	'9815-9953': 'newly printed or copied.',
	/* 3D6 =17 */
	'9954-10000': 'newly printed or copied.' /* 3D6 =18 */
}
gen_data['book_quality_fiction'] = {
	'1-46': 'you would rather rip your eyes out than read.',
	/* 3D6 =3 */
	'47-185': 'you would rather rip your eyes out than read.',
	/* 3D6 =4 */
	'186-462': 'You would sooner face Orcs than read this book.',
	/* 3D6 =5 */
	'463-925': 'You would sooner face Orcs than read this book.',
	/* 3D6 =6 */
	'926-1620': 'you could either read this or bang your head on the wall.',
	/* 3D6 =7 */
	'1621-2592': 'you could either read this or bang your head on the wall.',
	/* 3D6 =8 */
	'2593-3750': 'is predictable and formulaic.',
	/* 3D6 =9 */
	'3751-5000': 'is predictable and formulaic.',
	/* 3D6 =10 */
	'5001-6250': 'is a decent light read.',
	/* 3D6 =11 */
	'6251-7407': 'is a decent light read.',
	/* 3D6 =12 */
	'7408-8379': 'is engaging.',
	/* 3D6 =13 */
	'8380-9074': 'is engaging.',
	/* 3D6 =14 */
	'9075-9537': 'is a page turner.',
	/* 3D6 =15 */
	'9538-9814': 'is a page turner.',
	/* 3D6 =16 */
	'9815-9953': 'is a classic for the ages.',
	/* 3D6 =17 */
	'9954-10000': 'is a classic for the ages.' /* 3D6 =18 */
}
gen_data['book_quality_nonfiction'] = {
	'1-46': 'Dangerous - This book will impart dangerously wrong information.',
	/* 3D6 =3 */
	'47-185': 'Dangerous - This book will impart dangerously wrong information.',
	/* 3D6 =4 */
	'186-462': 'Worthless - The book is dead wrong, but not in a way that will hurt you.',
	/* 3D6 =5 */
	'463-925': 'Worthless - The book is dead wrong, but not in a way that will hurt you.',
	/* 3D6 =6 */
	'926-1620': 'Error prone - This book has just enough right information to hold up the wrong parts.',
	/* 3D6 =7 */
	'1621-2592': 'Error prone - This book has just enough right information to hold up the wrong parts.',
	/* 3D6 =8 */
	'2593-3750': 'Poorly researched - No patently bad data, but it is not well presented.',
	/* 3D6 =9 */
	'3751-5000': 'Poorly researched - No patently bad data, but it is not well presented.',
	/* 3D6 =10 */
	'5001-6250': 'A fair resource - Covers the subject well enough for the idly curious.',
	/* 3D6 =11 */
	'6251-7407': 'A fair resource - Covers the subject well enough for the idly curious.',
	/* 3D6 =12 */
	'7408-8379': 'A good resource - Covers the subject well enough for the dilettante. ',
	/* 3D6 =13 */
	'8380-9074': 'A good resource - Covers the subject well enough for the dilettante. ',
	/* 3D6 =14 */
	'9075-9537': 'An excellent resource - Covers the subject well enough for the serious ',
	/* 3D6 =15 */
	'9538-9814': 'An excellent resource - Covers the subject well enough for the serious ',
	/* 3D6 =16 */
	'9815-9953': 'The definitive resource - No better work on the subject.',
	/* 3D6 =17 */
