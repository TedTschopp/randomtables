...
gen_data["Roman_male_praenomina_common"] = [
    'Aulus', 'Decimus', 'Gaius', 'Gnaeus', 'Lucius', 'Marcus', 'Publius', 'Quintus', 'Tiberius', 'Titus'
]
gen_data["Roman_male_praenomina_uncommon"] = [
    'Appius', 'Aulus', 'Caeso', 'Decimus', 'Decius', 'Gaius', 'Gnaeus', 'Lucius', 'Mamercus', 'Manius', 'Marcus', 'Numerius', 'Publius', 'Quintus', 'Servius', 'Sextus', 'Spurius', 'Tiberius', 'Titus'
]

gen_data["Roman_male_praenomina"] = {
    '1-6' : '{Roman_male_praenomina_common}',
    '7-10': '{Roman_male_praenomina_uncommon}'
}


gen_data["Roman_male_nomina_common"] = [
    'Aemilius', 'Aurelius', 'Cornelius', 'Domitius', 'Fabius', 'Flavius', 'Horatius', 'Iulius', 'Livius', 'Valerius'
]
gen_data["Roman_male_nomina_uncommon"] = [
...
gen_data["Roman_male_nomina"] = {
    '1-6' : '{Roman_male_nomina_common}',
    '7-10': '{Roman_male_nomina_uncommon}'
}




gen_data["Roman_male_cognomina_common"] = [
    'Faustus', 'Felix', 'Fortunatus', 'Maximus', 'Proculus', 'Rufus', 'Sabinus', 'Saturninus', 'Severus', 'Victor'
]
gen_data["Roman_male_cognomina_ordinal"] = [
    'Primus', 'Secundus', 'Tertius', 'Quartus', 'Quintus', 'Sextus', 'Septimus', 'Octavius', 'Nonus', 'Decius'
]
gen_data["Roman_male_cognomina_uncommon"] = [
...
gen_data["Roman_male_cognomina"] = {
    '1-3' : '{Roman_male_cognomina_common}',
    '4-6' : '{Roman_male_cognomina_ordinal}',
    '7-10': '{Roman_male_cognomina_uncommon}'
}
gen_data["Roman_male_second_cognomina"] = {
    '1-6' : '{Roman_male_cognomina_common}',
    '7-10': '{Roman_male_cognomina_uncommon}'
}
gen_data["Roman_male_third_cognomina"] = {
    '1-6' : '{Roman_male_cognomina_common}',
    '7-10': '{Roman_male_cognomina_uncommon}'
}

gen_data["Roman_male_with_four_plus_names"] = {
    '1-19' : '{Roman_male_praenomina} {Roman_male_nomina} {Roman_male_cognomina} {Roman_male_second_cognomina}',
    '20'   : '{Roman_male_praenomina} {Roman_male_nomina} {Roman_male_cognomina} {Roman_male_second_cognomina} {Roman_male_third_cognomina}',
}

gen_data["Roman_male_name"] = {
    '1-29'  : '{Roman_male_praenomina} {Roman_male_nomina} {Roman_male_cognomina}',
    '30' : '{Roman_male_with_four_plus_names}'
}
