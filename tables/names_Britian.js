...
gen_data["Anglo_saxon_male_single"] = {
    '1-10': '{Anglo_saxon_single_base}',
    '11-20': '{Anglo_saxon_male_first_common}',
    '21-23': '{Anglo_saxon_male_first_noncommon}',
    '24-25': '{Anglo_saxon_male_first_common}la',
    '26': '{Anglo_saxon_male_first_noncommon}la',
    '27-28': '{Anglo_saxon_male_first_common}ela',
    '29': '{Anglo_saxon_male_first_noncommon}ela'
}
gen_data["Anglo_saxon_male_dual"] = {
    '1-20': '{Anglo_saxon_male_first_common}{Anglo_saxon_male_second_common}',
    '21-30': '{Anglo_saxon_male_first_common}{Anglo_saxon_male_second_noncommon}',
    '31-40': '{Anglo_saxon_male_first_noncommon}{Anglo_saxon_male_second_common}',
    '41-45': '{Anglo_saxon_male_first_noncommon}{Anglo_saxon_male_second_noncommon}',
}
gen_data["Anglo_saxon_male_name"] = {
    '1-20': '{Anglo_saxon_male_dual}',
    '21-40': '{Anglo_saxon_male_single}'
}


gen_data["Anglo_saxon_female_first_common"] = [
    'Aelf', 'Aethel', 'Beald', 'Beorht', 'Cwen', 'Deor', 'Ead', 'Eald', 'God', 'Gunn', 'Hild', 'Leof', 'Mild', 'Os', 'Sae', 'Sige', 'Thur', 'Wig', 'Wine', 'Wulf'
]
gen_data["Anglo_saxon_female_second_common"] = [
 'beald', 'beorht', 'burg', 'flaed', 'frith', 'gifu', 'gyth', 'here', 'hild', 'leofu', 'maer', 'or', 'raed', 'ric', 'sige', 'thryth', 'waru', 'weald', 'wig', 'wulf'
]
gen_data["Anglo_saxon_female_first_noncommon"] = [
...
gen_data["Anglo_saxon_female_second_noncommon"] = [
...
gen_data["Anglo_saxon_female_single"] = {
    '1-10': '{Anglo_saxon_single_base}',
    '11-20': '{Anglo_saxon_female_first_common}',
    '21-23': '{Anglo_saxon_female_first_noncommon}',
    '24-25': '{Anglo_saxon_female_first_common}el',
    '26': '{Anglo_saxon_female_first_noncommon}el'
}
gen_data["Anglo_saxon_female_dual"] = {
    '1-20': '{Anglo_saxon_female_first_common}{Anglo_saxon_female_second_common}',
    '21-30': '{Anglo_saxon_female_first_common}{Anglo_saxon_female_second_noncommon}',
    '31-40': '{Anglo_saxon_female_first_noncommon}{Anglo_saxon_female_second_common}',
    '41-45': '{Anglo_saxon_female_first_noncommon}{Anglo_saxon_female_second_noncommon}',
}
gen_data["Anglo_saxon_female_name"] = {
    '1-20': '{Anglo_saxon_male_dual}',
    '21-40': '{Anglo_saxon_male_single}'
}
...
gen_data["Cornish_male_first_common"] = [
    'Daveth', 'Digory', 'Gerens', 'Jacca', 'Jory', 'Margh', 'Myghal', 'Perran', 'Tristan', 'Wella'
]
gen_data["Cornish_male_first_uncommon"] = [
...
gen_data["Cornish_female_first_common"] = [
'Demelza', 'Eseld', 'Jenifer', 'Kerensa', 'Lowenna', 'Morwenna', 'Rosen', 'Tamsyn', 'Tryfena', 'Wenna'
]
gen_data["Cornish_female_first_uncommon"] = [
...
gen_data["Cornish_male_first"] = {
    '1-20': '{Cornish_male_first_common}',
    '21-30': '{Cornish_male_first_uncommon}',
}
gen_data["Cornish_female_first"] = {
    '1-20': '{Cornish_female_first_common}',
    '21-30': '{Cornish_female_first_uncommon}',
}


gen_data["Cornish_male_name"] = [
    '{Cornish_male_first}'
]
gen_data["Cornish_female_name"] = [
    '{Cornish_male_first}'
]


gen_data["English_male_first_common"] = [
    'Adam', 'Alan', 'Geoffrey', 'Gilbert', 'Henry', 'Hugh', 'John', 'Nicholas', 'Peter', 'Philip', 'Ralph', 'Reginald', 'Richard', 'Robert', 'Roger', 'Simon', 'Stephen', 'Thomas', 'Walter', 'William'
]
gen_data["English_male_first_uncommon"] = [
...
gen_data["English_female_first_uncommon"] = [
...
gen_data["English_female_first_rare"] = [
'Aldiva', 'Aldwina', 'Alexandra', 'Aleysia', 'Alieva', 'Alma', 'Anabila', 'Angelet', 'Athelyna', 'Barbota', 'Benedicta', 'Benigna', 'Bersaba', 'Byota', 'Camilla', 'Crestina', 'Desiree', 'Diane', 'Edida', 'Ediva', 'Ermengarda', 'Ermenilda', 'Erneburga', 'Esilia', 'Eve', 'Evelot', 'Fina', 'Flandrina', 'Frethesantha', 'Gemina', 'Gencelina', 'Goda', 'Godehyda', 'Godelda', 'Godeleva', 'Godiva', 'Godrun', 'Golda', 'Grisilde', 'Guida', 'Hadewisa', 'Hagenild', 'Helen', 'Hodierna', 'Holdyva', 'Humberh', 'Hyldeihera', 'Italia', 'Laura', 'Laurencia', 'Leofrun', 'Leveva', 'Lina', 'Livina', 'Lyneya', 'Marsona', 'Masota', 'Melodia', 'Mirabel', 'Nolicia', 'Olive', 'Olympia', 'Orphilia', 'Osanna', 'Pavia', 'Richemaye', 'Richende', 'Runild', 'Sabelina', 'Scientia', 'Sophie', 'Thomasine', 'Wyburh', 'Yerilda', 'Yvonne'
]

gen_data["English_male_name"] = {
    '1-80': '{English_male_first_common}',
    '81-95': '{English_male_first_uncommon}',
    '95-100': '{English_male_first_rare}'
}

gen_data["English_female_name"] = {
    '1-80': '{English_female_first_common}',
    '81-95': '{English_female_first_uncommon}',
    '95-100': '{English_female_first_rare}'
}




gen_data["Scottish_Highland_male_common"] = [
'Alasdar', 'Aonghus', 'Domhnall', 'Dubhghall', 'Eoghan', 'Eoin', 'Fearghus', 'Griogair', 'Lochloinn', 'Maghnus', 'Raghnall', 'Roibeard'

]
gen_data["Scottish_Highland_male_uncommon"] = [
...
gen_data["Scottish_Lowland_male_common"] = [
'John', 'William', 'Alexander', 'Andrew', 'David', 'Thomas', 'Robert', 'Gilbert', 'James', 'Patrick', 'Duncan', 'Richard'
]
gen_data["Scottish_Lowland_male_uncommon"] = [
...
gen_data["Scottish_Highland_male_name"] = {
    '1-80': '{Scottish_Highland_male_first_common}',
    '81-100': '{Scottish_Highland_male_first_uncommon}'
}

gen_data["Scottish_Lowland_male_name"] = {
    '1-80': '{Scottish_Lowland_male_first_common}',
    '81-100': '{Scottish_Lowland_male_first_uncommon}'
}




gen_data["Scottish_Highland_female_common"] = [
'Afraig', 'Beathag', 'Caitríona', 'Dearbháil', 'Ealusaid', 'Iosbail', 'Mairghread', 'Marsaili', 'Mór', 'Muirgheal', 'Raghnailt', 'Sitheag'
]
gen_data["Scottish_Highland_female_uncommon"] = [
...
gen_data["Scottish_Lowland_female_common"] = [
'Agnes', 'Annabell', 'Cristiane', 'Elizabeth', 'Ellen', 'Isabel', 'Jonet', 'Katherine', 'Margaret', 'Marion', 'Marjorie', 'Maude'
]
gen_data["Scottish_Lowland_female_uncommon"] = [
...
gen_data["Scottish_Highland_female_name"] = {
    '1-80': '{Scottish_Highland_female_first_common}',
    '81-100': '{Scottish_Highland_female_first_uncommon}'
}

gen_data["Scottish_Lowland_male_name"] = {
    '1-80': '{Scottish_Lowland_female_first_common}',
    '81-100': '{Scottish_Lowland_female_first_uncommon}'
}


gen_data["Irish_male_common"] = [
'Aodh', 'Brian', 'Conchobhar', 'Cormac', 'Domhnall', 'Eoghan', 'Niall', 'Séamus', 'Seán', 'Tadhgh'
]
gen_data["Irish_male_uncommon"] = [
...
gen_data["Irish_female_common"] = [
'Caitríona', 'Fionnghuala', 'Gormlaith', 'Gráinne', 'Máire', 'Máirghréad', 'Mór', 'Sadb', 'Sibán', 'Úna'
]
gen_data["Irish_female_uncommon"] = [
...
gen_data["Gaelic_male_name"] = {
    '1-80': '{Gaelic_male_first_common}',
    '81-100': '{Gaelic_male_first_uncommon}'
}
gen_data["Gaelic_female_name"] = {
    '1-80': '{Gaelic_female_first_common}',
    '81-100': '{Gaelic_female_first_uncommon}'
}




gen_data["Welsh_male_common"] = [
'Adam', 'Cynwrig', 'David', 'Einion', 'Gronw', 'Gwyn', 'Ieuan', 'Iorwerth', 'Ithel', 'Madog'
]
gen_data["Welsh_male_uncommon"] = [
...
gen_data["Welsh_female_common"] = [
'Angharad', 'Dyddgu', 'Generys', 'Gwenhwyfar', 'Gwenllian', 'Gwerfyl', 'Gwladus', 'Lleucu', 'Morfudd', 'Tangwystl'
]
gen_data["Welsh_female_uncommon"] = [
...
gen_data["Welsh_male_name"] = {
    '1-80': '{Welsh_male_first_common}',
    '81-100': '{Welsh_male_first_uncommon}'
}
gen_data["Welsh_female_name"] = {
    '1-80': '{Welsh_female_first_common}',
    '81-100': '{Welsh_female_first_uncommon}'
}


gen_data["Briton_male_name"] = [
...
// TODO: LAst Names based on Locality, Relationship, Occupation, Nickname
// TODO: Build up cultural mixes by percentages.